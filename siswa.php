...
// Query untuk mengambil data siswa dengan informasi kelas dan wali murid
$query = "SELECT siswa.*, kelas.nama_kelas, wali_murid.nama_wali 
          FROM siswa 
          LEFT JOIN kelas ON siswa.id_kelas = kelas.id_kelas
          LEFT JOIN wali_murid ON siswa.id_siswa = wali_murid.id_siswa"; // Menggunakan id_siswa untuk join
